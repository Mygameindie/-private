...
(function setupFrozenAppendOnly(){
  ...
  function ensureFrozenVisual() {
    ...
    let frozenImg = document.getElementById('frozen');
    if (!frozenImg) {
  ...
  function attach() {
    ...
    btn.addEventListener('click', () => {
      ...
      if (frozenImg.style.display === 'none') {
        ...
        frozenImg.classList.remove('frozen-active');
        void frozenImg.offsetWidth;
        frozenImg.classList.add('frozen-active');
      } else {
        frozenImg.style.display = 'none';
        frozenImg.classList.remove('frozen-active');
      }
